...
const OCRResultsSidebar = ({ 
  ...
  const handleGenerateVideo = async (latexContent) => {
    try {
      console.log('🎬 Starting video generation for:', latexContent);
      ...
      if (response.success) {
        ...
        alert(`Video generation started! Task ID: ${response.task_id}`);
        
        // You could add state management here to track generation progress
      } else {
                      ...
                      <div key={index} className="bg-gray-50 p-3 rounded-lg border">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <button
                              onClick={() => handleGenerateVideo(typeof formula === 'string' ? formula : formula.latex)}
